...
class ConnectorGooseSender {
    ...
    void send_goose_frame(goose::frame::GoosePDU pdu, uint16_t appid);
...
public:
     ...
     */
    void send_stop_request(uint16_t connector_no);
     ...
     * frame
     */
    void send_power_requirement(uint16_t connector_no, PowerRequirement requirement);
     ...
     * @param connector_no The global connector number
     */
    void send_module_placeholder_request(uint16_t connector_no);
     ...
     */
    void send_insulation_detection_voltage_output(uint16_t connector_no, float voltage, float current);
     ...
     * @param connector_no The global connector number
     */
    void send_insulation_detection_voltage_output_stoppage(uint16_t connector_no);
     ...
     * @param current The requested current
     */
    void send_precharge_voltage_output(uint16_t connector_no, float voltage, float current);
     ...
     * @param current The requested current
     */
    void send_charging_voltage_output(uint16_t connector_no, float voltage, float current);
};
