...
ocpp::v201::MeterValues::MeterValues(MessageDispatcherInterface<MessageType>& message_dispatcher,
...
void ocpp::v201::MeterValues::handle_message(const ocpp::EnhancedMessage<MessageType>& message) {
    throw MessageTypeNotImplementedException(message.messageType);
}

void ocpp::v201::MeterValues::update_aligned_data_interval() {
...
void ocpp::v201::MeterValues::on_meter_value(const int32_t evse_id, const MeterValue& meter_value) {
    if (evse_id == 0) {
...
ocpp::v201::MeterValues::get_latest_meter_value_filtered(const MeterValue& meter_value, ReadingContextEnum context,
...
void ocpp::v201::MeterValues::meter_values_req(const int32_t evse_id, const std::vector<MeterValue>& meter_values,
...
void ocpp::v201::MeterValues::update_dm_evse_power(const int32_t evse_id, const MeterValue& meter_value) {
