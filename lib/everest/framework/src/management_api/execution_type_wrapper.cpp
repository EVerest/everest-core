...
StopModulesResultEnum_Internal to_internal_api(StopModulesResultEnum_External const& val) {
    ...
    throw std::out_of_range("Unexpected value for everest::lib::API::V1_0::types::execution::StopModulesResultEnum");
}
...
StartModulesResultEnum_Internal to_internal_api(StartModulesResultEnum_External const& val) {
    ...
    throw std::out_of_range("Unexpected value for everest::lib::API::V1_0::types::execution::StartModulesResultEnum");
}
