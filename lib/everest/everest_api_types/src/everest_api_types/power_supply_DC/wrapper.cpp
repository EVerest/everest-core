...
Mode_External toExternalApi(Mode_Internal mode_internal) {
...
Mode_Internal toInternalApi(Mode_External mode_external) {
...
VoltageCurrent_External toExternalApi(VoltageCurrent_Internal const& internal) {
...
VoltageCurrent_Internal toInternalApi(VoltageCurrent_External const& external) {
