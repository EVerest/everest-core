...
UploadLogsResponse_Internal toInternalApi(UploadLogsResponse_External const& val) {
    ...
    result.upload_logs_status = toInternalApi(val.upload_logs_status);
...
UploadLogsResponse_External toExternalApi(UploadLogsResponse_Internal const& val) {
    ...
    result.upload_logs_status = toExternalApi(val.upload_logs_status);
    result.file_name = val.file_name;
    return result;
}
...
LogStatus_Internal toInternalApi(LogStatus_External const& val) {
    ...
    result.log_status = toInternalApi(val.log_status);
    result.request_id = val.request_id;
    return result;
}
LogStatus_External toExternalApi(LogStatus_Internal const& val) {
    LogStatus_External result;
    result.log_status = toExternalApi(val.log_status);
    result.request_id = val.request_id;
    return result;
}
...
FirmwareUpdateStatus_Internal toInternalApi(FirmwareUpdateStatus_External const& val) {
    ...
    result.firmware_update_status = toInternalApi(val.firmware_update_status);
    result.request_id = val.request_id;
    return result;
}
FirmwareUpdateStatus_External toExternalApi(FirmwareUpdateStatus_Internal const& val) {
    FirmwareUpdateStatus_External result;
    result.firmware_update_status = toExternalApi(val.firmware_update_status);
    result.request_id = val.request_id;
    return result;
}
