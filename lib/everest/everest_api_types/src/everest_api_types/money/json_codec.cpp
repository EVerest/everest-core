...
void to_json(json& j, CurrencyCode const& k) noexcept {
    ...
    j = "INVALID_VALUE__everest::lib::API::V1_0::types::session_cost::CurrencyCode";
}
void from_json(const json& j, CurrencyCode& k) {
    ...
    throw std::out_of_range(
        "Provided string " + s +
        " could not be converted to enum of type everest::lib::API::V1_0::types::session_cost::CurrencyCode");
}
