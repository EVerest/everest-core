...
CurrencyCode_Internal to_internal_api(CurrencyCode_External const& val) {
    ...
    throw std::out_of_range("Unexpected value for everest::lib::API::V1_0::types::session_cost::CurrencyCode_External");
}
...
CurrencyCode_External to_external_api(CurrencyCode_Internal const& val) {
    ...
    throw std::out_of_range("Unexpected value for everest::lib::API::V1_0::types::session_cost::CurrencyCode_Internal");
}
