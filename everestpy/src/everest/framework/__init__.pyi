...
class Module:
    ...
    def raise_error(self, implementation_id: str, error_type: str, message: str, severity: str) -> str: ...
    def subscribe_error(self, fulfillment: Fulfillment, error_type: str, error_cb: Callable[[dict], None], error_cleared_cb: Callable[[dict], None]) -> None: ...
    def subscribe_all_errors(self, fulfillment: Fulfillment, error_cb: Callable[[dict], None], error_cleared_cb: Callable[[dict], None]) -> None: ...
    def request_clear_error_uuid(self, implementation_id: str, uuid: str) -> dict: ...
    def request_clear_error_all_of_type(self, implementation_id: str, error_type: str) -> dict: ...
    def request_clear_error_all(self, implementation_id: str) -> dict: ...
