...
#ifndef OCPP1_6_SMART_CHARGING_HPP
#define OCPP1_6_SMART_CHARGING_HPP
...
private:
    ...
    ///
    PeriodDateTimePair find_period_at(const DateTime& time, const ChargingProfile& profile, const int connector_id);
    ...
    /// purposes
    ///
    boost::optional<DateTime> get_profile_start_time(const ChargingProfile& profile, const DateTime& time,
    ...
    ///
    DateTime get_next_temp_time(const DateTime temp_time, const std::vector<ChargingProfile>& valid_profiles,
                                const int connector_id);
...
public:
    ...
    /// connector_id
    ///
    std::vector<ChargingProfile> get_valid_profiles(const DateTime& start_time, const DateTime& end_time,
                                                    const int connector_id);
    ///
...
#endif // OCPP1_6_SMART_CHARGING_HPP
