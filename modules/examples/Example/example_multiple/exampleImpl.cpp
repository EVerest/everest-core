...
void exampleImpl::ready() {
    ...
    const auto error_object0 =
        this->error_factory->create_error("example/ExampleErrorA", "", "index0", Everest::error::Severity::High);
    const auto error_object1 =
        this->error_factory->create_error("example/ExampleErrorA", "", "index1", Everest::error::Severity::High);
