...
public:
    ...
    virtual types::json_rpc_api::ErrorResObj setDCCharging(const int32_t evse_index, bool charging_allowed, float max_power) = 0;
    virtual types::json_rpc_api::ErrorResObj setDCChargingPower(const int32_t evse_index, float max_power) = 0;
