...
#ifndef GOOGLE_PROTOBUF_INCLUDED_control_5fservice_2fmessages_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_control_5fservice_2fmessages_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:control_service.SetConfigRequest) */ {
 ...
 private:
  ...
  struct Impl_ {
    ...
    mutable ::google::protobuf::internal::CachedSize _device_categories_cached_byte_size_;
    ::google::protobuf::RepeatedField<int> entity_types_;
    mutable ::google::protobuf::internal::CachedSize _entity_types_cached_byte_size_;
...
class RegisterRemoteSkiRequest final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:control_service.RegisterRemoteSkiRequest) */ {
 public:
  ...
  ~RegisterRemoteSkiRequest() override;
  template <typename = void>
  ...
  RegisterRemoteSkiRequest* New(::google::protobuf::Arena* arena = nullptr) const final {
...
class AddUseCaseResponse final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:control_service.AddUseCaseResponse) */ {
 public:
  ...
  AddUseCaseResponse* New(::google::protobuf::Arena* arena = nullptr) const final {
...
class SubscribeUseCaseEventsRequest final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:control_service.SubscribeUseCaseEventsRequest) */ {
 public:
  ...
  ~SubscribeUseCaseEventsRequest() override;
  template <typename = void>
  ...
  SubscribeUseCaseEventsRequest* New(::google::protobuf::Arena* arena = nullptr) const final {
...
/* @@protoc_insertion_point(class_definition:control_service.RemoveEntityRequest) */ {
 public:
  ...
  RemoveEntityRequest* New(::google::protobuf::Arena* arena = nullptr) const final {
...
class AddUseCaseRequest final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:control_service.AddUseCaseRequest) */ {
 public:
  ...
  AddUseCaseRequest* New(::google::protobuf::Arena* arena = nullptr) const final {
...
/* @@protoc_insertion_point(class_definition:control_service.AddEntityRequest) */ {
 public:
  ...
  AddEntityRequest* New(::google::protobuf::Arena* arena = nullptr) const final {
...
class SubscribeUseCaseEventsResponse final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:control_service.SubscribeUseCaseEventsResponse) */ {
 public:
  ...
  ~SubscribeUseCaseEventsResponse() override;
  template <typename = void>
  ...
  SubscribeUseCaseEventsResponse* New(::google::protobuf::Arena* arena = nullptr) const final {
...
inline void SetConfigRequest::set_allocated_vendor_code(std::string* value) {
  ...
  _impl_.vendor_code_.SetAllocated(value, GetArena());
        ...
        if (_impl_.vendor_code_.IsDefault()) {
...
inline void RegisterRemoteSkiRequest::set_allocated_remote_ski(std::string* value) {
  ...
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
        if (_impl_.remote_ski_.IsDefault()) {
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_control_5fservice_2fmessages_2eproto_2epb_2eh
