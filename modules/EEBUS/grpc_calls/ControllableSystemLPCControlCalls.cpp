...
void ControllableSystemLPCControlCalls::call_set_consumption_nominal_max() {
    cs_lpc::SetConsumptionNominalMaxRequest request = cs_lpc::CreateSetConsumptionNominalMaxRequest(
        32000 // LTODO: make this a parameter
    );
...
void ControllableSystemLPCControlCalls::call_set_consumption_limit() {
    common_types::LoadLimit load_limit = common_types::CreateLoadLimit(
        ...
        4200,
        false
    ); // LTODO proper load limit
    cs_lpc::SetConsumptionLimitRequest request = cs_lpc::CreateSetConsumptionLimitRequest(
        &load_limit
    );
...
void ControllableSystemLPCControlCalls::call_set_failsafe_consumption_active_power_limit() {
    cs_lpc::SetFailsafeConsumptionActivePowerLimitRequest request = cs_lpc::CreateSetFailsafeConsumptionActivePowerLimitRequest(
        4200,
        true
    ); // LTODO set proper failsafe consumption active power limit
...
void ControllableSystemLPCControlCalls::call_set_failsafe_duration_minimum() {
    cs_lpc::SetFailsafeDurationMinimumRequest request = cs_lpc::CreateSetFailsafeDurationMinimumRequest(
