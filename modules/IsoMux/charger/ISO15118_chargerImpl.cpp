...
void ISO15118_chargerImpl::handle_setup(
    ...
    types::iso15118::SaeJ2847BidiMode& sae_j2847_mode, bool& debug_mode, bool& mcs_enable) {
    mod->r_iso20->call_setup(evse_id, supported_energy_transfer_modes, sae_j2847_mode, debug_mode, mcs_enable);
    mod->r_iso2->call_setup(evse_id, supported_energy_transfer_modes, sae_j2847_mode, debug_mode, mcs_enable);
}
