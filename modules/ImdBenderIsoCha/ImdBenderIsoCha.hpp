...
#ifndef IMD_BENDER_ISO_CHA_HPP
#define IMD_BENDER_ISO_CHA_HPP
...
class ImdBenderIsoCha : public Everest::ModuleBase {
public:
    ImdBenderIsoCha() = delete;
    ImdBenderIsoCha(const ModuleInfo& info, std::unique_ptr<isolation_monitorImplBase> p_main,
