.. _everest_modules_handwritten_DummySessionCostProvider:

..  This file is a placeholder for optional multiple files
    handwritten documentation for the DummySessionCostProvider module.
...
*******************************************
DummySessionCostProvider
*******************************************

:ref:`Link <everest_modules_DummySessionCostProvider>` to the module's reference.
