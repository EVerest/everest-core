.. _everest_modules_handwritten_BUSystem:

..  This file is a placeholder for optional multiple files
    handwritten documentation for the BUSystem module.
...
:ref:`Link <everest_modules_BUSystem>` to the module's reference.
Interactive bring up helper for Systemd component
