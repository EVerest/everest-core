.. _everest_modules_handwritten_BUOcppConsumer:

..  This file is a placeholder for optional multiple files
    handwritten documentation for the BUOcppConsumer module.
...
:ref:`Link <everest_modules_BUOcppConsumer>` to the module's reference.
Interactive bring up helper for OCPP consumer interface
