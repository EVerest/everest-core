...
// this should go into a seperate header file
class Conf {
...
private:
    ...
    int get_connection_timeout() {
        std::lock lk<std::mutex(m);
    }

    // autogenerated
    ConfigurationResponse set_connection_timeout(int value);
};

// autogenerated
ConfigurationResponse Auth::set_connection_timeout(int value) {
    ConfigurationResponse r;
    r.status = ConfigurationResponse::Accepted;
    // @ add user code
    // @ add user code end
    return r;
}
...
ConfigurationResponse Auth::set_connection_timeout(int value) {
    ...
    if (timer.running()) {
        status.info = "";
        return ConfigurationResponse::Rejected;
    }
    this->config.set_connection_timeout(value);
    return ConfigurationResponse::Accepted;
    // user defined end
}
