...
#ifndef DEBUG_POWERMETER_DEBUG_JSON_IMPL_HPP
#define DEBUG_POWERMETER_DEBUG_JSON_IMPL_HPP
...
public:
    ...
    debug_jsonImpl(Everest::ModuleAdapter* ev, const Everest::PtrContainer<YetiDriver>& mod, Conf& config) :
        debug_jsonImplBase(ev, "debug_powermeter"), mod(mod), config(config){};
...
#endif // DEBUG_POWERMETER_DEBUG_JSON_IMPL_HPP
