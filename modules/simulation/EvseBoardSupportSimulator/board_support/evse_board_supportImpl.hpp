...
public:
    ...
    evse_board_supportImpl(Everest::ModuleAdapter* ev, const Everest::PtrContainer<EvseBoardSupportSimulator>& mod,
                           Conf& config) :
...
private:
    const Everest::PtrContainer<EvseBoardSupportSimulator>& mod;
    const Conf& config;
