...
std::vector<Everest::error::ErrorPtr> get_test_errors() {
    return {
        ...
        std::make_shared<Everest::error::Error>(
            ...
            ImplementationIdentifier("test_origin_module_a", "test_origin_implementation_a"), Everest::error::Severity::Low,
        ...
        std::make_shared<Everest::error::Error>(
            ...
            ImplementationIdentifier("test_origin_module_b", "test_origin_implementation_b"), Everest::error::Severity::Low,
        ...
        std::make_shared<Everest::error::Error>(
            "test_type_c", "test_sub_type_c", "test_message_c", "test_description_c",
            ImplementationIdentifier("test_origin_module_c", "test_origin_implementation_c"), Everest::error::Severity::Low,
