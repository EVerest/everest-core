...
namespace module::device_model {
    class EverestDeviceModelStorage : public ocpp::v201::DeviceModelInterface {
        public:
            ...
            virtual bool set_variable_attribute_value(const ocpp::v201::Component &component_id, const ocpp::v201::Variable &variable_id, const ocpp::v201::AttributeEnum &attribute_enum, const std::string &value, const std::string &source) override;
            virtual std::optional<ocpp::v201::VariableMonitoringMeta> set_monitoring_data(const ocpp::v201::SetMonitoringData &data, const ocpp::v201::VariableMonitorType type) override;
            virtual bool update_monitoring_reference(const int32_t monitor_id, const std::string &reference_value) override;
            virtual std::vector<ocpp::v201::VariableMonitoringMeta> get_monitoring_data(const std::vector<ocpp::v201::MonitoringCriterionEnum> &criteria, const ocpp::v201::Component &component_id, const ocpp::v201::Variable &variable_id) override;
