...
#ifndef AD_ACEVSE22KWZ_KIT_AC_RCD_IMPL_HPP
#define AD_ACEVSE22KWZ_KIT_AC_RCD_IMPL_HPP
...
public:
    ac_rcdImpl() = delete;
    ac_rcdImpl(Everest::ModuleAdapter* ev, const Everest::PtrContainer<AdAcEvse22KwzKitBSP>& mod, Conf& config) :
...
#endif // AD_ACEVSE22KWZ_KIT_AC_RCD_IMPL_HPP
