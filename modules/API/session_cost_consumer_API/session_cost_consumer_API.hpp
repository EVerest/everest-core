...
#ifndef SESSION_COST_CONSUMER_API_HPP
#define SESSION_COST_CONSUMER_API_HPP
...
public:
    session_cost_consumer_API() = delete;
    session_cost_consumer_API(const ModuleInfo& info, Everest::MqttProvider& mqtt_provider,
...
#endif // SESSION_COST_CONSUMER_API_HPP
