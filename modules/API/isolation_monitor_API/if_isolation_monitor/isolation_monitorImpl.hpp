...
#ifndef IF_ISOLATION_MONITOR_ISOLATION_MONITOR_IMPL_HPP
#define IF_ISOLATION_MONITOR_ISOLATION_MONITOR_IMPL_HPP
...
public:
    ...
    isolation_monitorImpl(Everest::ModuleAdapter* ev, const Everest::PtrContainer<isolation_monitor_API>& mod,
                          Conf& config) :
        isolation_monitorImplBase(ev, "if_isolation_monitor"), mod(mod), config(config){};
...
#endif // IF_ISOLATION_MONITOR_ISOLATION_MONITOR_IMPL_HPP
