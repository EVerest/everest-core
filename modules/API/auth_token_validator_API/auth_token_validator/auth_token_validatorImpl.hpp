...
#ifndef AUTH_TOKEN_VALIDATOR_AUTH_TOKEN_VALIDATOR_IMPL_HPP
#define AUTH_TOKEN_VALIDATOR_AUTH_TOKEN_VALIDATOR_IMPL_HPP
...
public:
    ...
    auth_token_validatorImpl(Everest::ModuleAdapter* ev, const Everest::PtrContainer<auth_token_validator_API>& mod,
                             Conf& config) :
        auth_token_validatorImplBase(ev, "auth_token_validator"), mod(mod), config(config){};
...
#endif // AUTH_TOKEN_VALIDATOR_AUTH_TOKEN_VALIDATOR_IMPL_HPP
