...
#ifndef IF_POWER_SUPPLY_DC_POWER_SUPPLY_DC_IMPL_HPP
...
public:
    ...
    power_supply_DCImpl(Everest::ModuleAdapter* ev, const Everest::PtrContainer<power_supply_DC_API>& mod,
                        Conf& config) :
        power_supply_DCImplBase(ev, "if_power_supply_DC"), mod(mod), config(config){};
...
#endif // IF_POWER_SUPPLY_DC_POWER_SUPPLY_DC_IMPL_HPP
