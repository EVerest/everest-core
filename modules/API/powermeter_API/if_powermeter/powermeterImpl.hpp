...
#ifndef IF_POWERMETER_POWERMETER_IMPL_HPP
#define IF_POWERMETER_POWERMETER_IMPL_HPP
...
public:
    ...
    powermeterImpl(Everest::ModuleAdapter* ev, const Everest::PtrContainer<powermeter_API>& mod, Conf& config) :
        powermeterImplBase(ev, "if_powermeter"), mod(mod), config(config){};
...
private:
    const Everest::PtrContainer<powermeter_API>& mod;
    const Conf& config;
...
#endif // IF_POWERMETER_POWERMETER_IMPL_HPP
