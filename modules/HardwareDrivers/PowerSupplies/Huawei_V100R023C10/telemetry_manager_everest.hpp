...
class TelementryManagerEverest : public fusion_charger::telemetry::TelemetryManagerBase {
...
public:
    TelementryManagerEverest(std::function<void(const std::string&, const nlohmann::json&)> publish_func,
                             const std::string& base_topic);
    ~TelementryManagerEverest() override;
