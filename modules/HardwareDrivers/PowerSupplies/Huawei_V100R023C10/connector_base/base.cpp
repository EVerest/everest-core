...
ConnectorBase::ConnectorBase(uint8_t connector, power_supply_DCImplBase* impl) :
...
void ConnectorBase::update_and_publish_capabilities() {
    ...
    new_caps.max_export_current_A = std::min((double)new_caps.max_export_current_A, config.max_export_current_A);
    new_caps.max_export_power_W = std::min((double)new_caps.max_export_power_W, config.max_export_power_W);
