...
TEST_F(DispenserWithTlsTest, ErrorReportingPowerUnit) {
    ...
    EXPECT_THAT(dispenser->get_raised_errors(),
                testing::ElementsAre(ErrorEvent{
                    ...
                    .error_subcategory = {.power_unit = ErrorSubcategoryPowerUnit::HighVoltageDoorStatusSensor},
    ...
    EXPECT_THAT(
        ...
        testing::ElementsAre(
            ErrorEvent{
                ...
                .error_subcategory = {.charging_power_unit = ErrorSubcategoryChargingPowerUnit::SoftStartFault},
                .payload = ErrorPayload{.alarm = AlarmStatus::ALARM},
            },
            ErrorEvent{
                .error_category = ErrorCategory::ChargingPowerUnit,
                .error_subcategory = {.charging_power_unit = ErrorSubcategoryChargingPowerUnit::ModbusTcpCertificate},
    ...
    EXPECT_THAT(dispenser->get_raised_errors(),
                testing::ElementsAre(
                    ErrorEvent{
                        ...
                        .error_subcategory = {.ac_branch = ErrorSubcategoryAcBranch::AcBranch1},
                        .payload = ErrorPayload{.error_flags = 1},
                    },
                    ErrorEvent{
                        .error_category = ErrorCategory::AcBranch,
                        .error_subcategory = {.ac_branch = ErrorSubcategoryAcBranch::AcBranch2},
    ...
    EXPECT_THAT(dispenser->get_raised_errors(),
                testing::ElementsAre(
                    ErrorEvent{
                        ...
                        .error_subcategory = {.ac_dc_rectifier = ErrorSubcategoryAcDcRectifier::rectifier_1},
                        .payload = ErrorPayload{.error_flags = 1},
                    },
                    ErrorEvent{
                        .error_category = ErrorCategory::AcDcRectifier,
                        .error_subcategory = {.ac_dc_rectifier = ErrorSubcategoryAcDcRectifier::rectifier_6},
                        .payload = ErrorPayload{.error_flags = 0x10000},
                    }));
}
    ...
    EXPECT_THAT(
        ...
        testing::ElementsAre(
            ErrorEvent{
                ...
                .error_subcategory = {.dc_dc_charging_module = ErrorSubcategoryDcDcChargingModule::DcDcModule1},
                .payload = ErrorPayload{.error_flags = 1},
            },
            ErrorEvent{
                .error_category = ErrorCategory::DcDcChargingModule,
                .error_subcategory = {.dc_dc_charging_module = ErrorSubcategoryDcDcChargingModule::DcDcModule12},
                .payload = ErrorPayload{.error_flags = 0x10000},
            }));
}
...
TEST_F(DispenserWithTlsTest, ErrorReportingCoolingSection) {
    ...
    EXPECT_THAT(dispenser->get_raised_errors(),
                testing::ElementsAre(ErrorEvent{
                    ...
                    .error_subcategory = {.cooling_section = ErrorSubcategoryCoolingSection::CoolingUnit1},
...
TEST_F(DispenserWithTlsTest, ErrorReportingPowerDistributionModule) {
    ...
    EXPECT_THAT(dispenser->get_raised_errors(),
                testing::ElementsAre(
                    ErrorEvent{
                        .error_category = ErrorCategory::ErrorSubcategoryPowerDistributionModule,
                        .error_subcategory = {.power_distribution_module =
