...
/**
 * @brief Base interface class for fusion charger telemetry managers
 */
class TelemetryManagerBase {
public:
    virtual ~TelemetryManagerBase() = default;
    /**
...
/**
 * @brief Null implementation of the TelemetryManagerBase that does nothing
 */
class TelemetryManagerNull : public TelemetryManagerBase {
public:
