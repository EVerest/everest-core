...
static void server() {
  ...
  set_ca(ctx);
  ASS_POS(SSL_CTX_use_certificate_file(ctx, SERVER_BASE_NAME CERTF,
                                       SSL_FILETYPE_PEM));
  ASS_POS(SSL_CTX_use_PrivateKey_file(ctx, SERVER_BASE_NAME KEYF,
                                      SSL_FILETYPE_PEM));
...
static void client() {
  ...
  set_ca(ctx);
  ASS_POS(SSL_CTX_use_certificate_file(ctx, CLIENT_BASE_NAME CERTF,
                                       SSL_FILETYPE_PEM));
  ASS_POS(SSL_CTX_use_PrivateKey_file(ctx, CLIENT_BASE_NAME KEYF,
                                      SSL_FILETYPE_PEM));
