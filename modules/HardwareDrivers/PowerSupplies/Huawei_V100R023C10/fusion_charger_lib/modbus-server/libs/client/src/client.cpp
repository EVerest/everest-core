...
ModbusClient::ModbusClient(std::shared_ptr<PDUCorrelationLayerIntf> pas)
    : pas(pas) {}
...
std::vector<uint16_t> ModbusClient::read_holding_registers(
...
void ModbusClient::write_multiple_registers(
