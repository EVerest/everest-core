...
class ModbusBasicServer {
 public:
  ...
  using AlwaysRespondingPDUHandler = std::function<Res(Req)>;
 ...
 protected:
  ...
  std::optional<AlwaysRespondingPDUHandler<pdu::ReadHoldingRegistersRequest,
                                           pdu::ReadHoldingRegistersResponse>>
      read_registers_request;
  std::optional<AlwaysRespondingPDUHandler<pdu::WriteMultipleRegistersRequest,
                                           pdu::WriteMultipleRegistersResponse>>
      write_multiple_registers_request;
  std::optional<AlwaysRespondingPDUHandler<pdu::WriteSingleRegisterRequest,
                                           pdu::WriteSingleRegisterResponse>>
      write_single_register_request;

 public:
  ModbusBasicServer(std::shared_ptr<PDUCorrelationLayerIntf> pas,
 ...
 protected:
   ...
   */
  std::optional<pdu::GenericPDU> on_pdu_error_handled(
