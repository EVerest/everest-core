...
public:
    ComplexRegister(uint16_t start_address, data_providers::DataProvider<provider_type>& data_provider,
                    const converters::Converter& converter) :
...
public:
    StringRegister(uint16_t start_address, data_providers::DataProviderString<string_length>& data_provider,
                   const converters::Converter& converter) :
 ...
 */
template <size_t array_size> class MemoryRegister : public ComplexRegister<const uint8_t*, array_size> {
public:
    MemoryRegister(uint16_t start_address, data_providers::DataProviderMemory<array_size>& data_provider,
                   const converters::Converter& converter) :
        ComplexRegister<const uint8_t*, array_size>(start_address, data_provider, converter) {
    }
...
public:
    ElementaryRegister(uint16_t start_address, data_providers::DataProvider<T>& data_provider,
                       const converters::Converter& converter) :
