...
TEST(Registry, write_cases) {
    ...
    subregistry->add(new ElementaryRegister<uint32_t>(0x0010, provider, ConverterABCD::instance()));
    subregistry->add(new ElementaryRegister<uint64_t>(0x0012, provider2, ConverterABCD::instance()));
...
TEST(Registry, read_cases) {
    DataProviderHolding<uint32_t> provider(0x0010);
    DataProviderHolding<uint64_t> provider2(0x0012);
