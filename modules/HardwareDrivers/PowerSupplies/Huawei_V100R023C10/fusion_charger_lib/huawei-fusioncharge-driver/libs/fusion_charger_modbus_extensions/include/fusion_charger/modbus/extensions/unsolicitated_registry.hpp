...
class UnsolicitatedRegistry
    : public modbus::registers::registry::ComplexRegisterRegistry {
 public:
  UnsolicitatedRegistry()
      : modbus::registers::registry::ComplexRegisterRegistry() {}

  std::optional<fusion_charger::modbus_extensions::UnsolicitatedReportRequest>
  unsolicitated_report() {
    fusion_charger::modbus_extensions::UnsolicitatedReportRequest::Device
        req_device;
