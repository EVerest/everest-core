...
TEST(RegisterOverlap, all_connectors_no_overlap) {
  ...
  std::copy(std::begin(mac), std::end(mac),
            std::begin(connector_register_config1.mac_address));
  ...
  connector_register_config1.get_contactor_upstream_voltage = []() {
    return 0.0;
  };
  ...
  std::copy(std::begin(mac), std::end(mac),
            std::begin(connector_register_config2.mac_address));
  ...
  connector_register_config2.get_contactor_upstream_voltage = []() {
    return 0.0;
  };
  ...
  std::copy(std::begin(mac), std::end(mac),
            std::begin(connector_register_config3.mac_address));
  ...
  connector_register_config3.get_contactor_upstream_voltage = []() {
    return 0.0;
  };
  ...
  std::copy(std::begin(mac), std::end(mac),
            std::begin(connector_register_config4.mac_address));
  ...
  connector_register_config4.get_contactor_upstream_voltage = []() {
    return 0.0;
  };
