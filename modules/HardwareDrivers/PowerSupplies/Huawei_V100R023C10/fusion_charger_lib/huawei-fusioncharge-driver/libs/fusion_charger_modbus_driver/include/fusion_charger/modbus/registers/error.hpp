...
enum class ErrorSubcategoryPowerUnit : uint16_t {
...
enum class ErrorSubcategoryChargingPowerUnit : uint16_t {
  UnknownSystemType = 0,
...
enum class ErrorSubcategoryAcBranch : uint16_t {
  AcBranch1 = 0,
  AcBranch2 = 1,
};

enum class ErrorSubcategoryAcDcRectifier : uint16_t {
  rectifier_1 = 0,
  rectifier_2 = 1,
  rectifier_3 = 2,
  rectifier_4 = 3,
...
enum class ErrorSubcategoryDcDcChargingModule : uint16_t {
  DcDcModule1 = 0,
  DcDcModule2 = 1,
  DcDcModule3 = 2,
  DcDcModule4 = 3,
...
enum class ErrorSubcategoryCoolingSection : uint16_t {
  CoolingUnit1 = 0,
};

enum class ErrorSubcategoryPowerDistributionModule : uint16_t {
...
inline std::ostream& operator<<(std::ostream&                    os,
                                const ErrorSubcategoryPowerUnit& subcategory) {
  switch (subcategory) {
...
inline std::ostream& operator<<(
    std::ostream& os, const ErrorSubcategoryChargingPowerUnit& subcategory) {
  switch (subcategory) {
    ...
    case ErrorSubcategoryChargingPowerUnit::PowerDetectionException:
      ...
      break;
    case ErrorSubcategoryChargingPowerUnit::
        SyncrhonizationCableStatusFaultOfEnergyRoutingBoard:
    ...
    case ErrorSubcategoryChargingPowerUnit::PhaseSequenceAbornmalAlarm:
      ...
      break;
    case ErrorSubcategoryChargingPowerUnit::
        PowerDistributionModuleCommunicationFailure:
...
inline std::ostream& operator<<(std::ostream&                   os,
                                const ErrorSubcategoryAcBranch& subcategory) {
  switch (subcategory) {
...
inline std::ostream& operator<<(
    std::ostream& os, const ErrorSubcategoryAcDcRectifier& subcategory) {
  switch (subcategory) {
...
inline std::ostream& operator<<(
    std::ostream& os, const ErrorSubcategoryDcDcChargingModule& subcategory) {
  switch (subcategory) {
...
inline std::ostream& operator<<(
    std::ostream& os, const ErrorSubcategoryCoolingSection& subcategory) {
  switch (subcategory) {
...
inline std::ostream& operator<<(
    std::ostream&                                  os,
    const ErrorSubcategoryPowerDistributionModule& subcategory) {
  switch (subcategory) {
...
union ErrorSubcategory {
  ...
  bool operator<(const ErrorSubcategory& rhs) const { return raw < rhs.raw; }
  bool operator==(const ErrorSubcategory& rhs) const { return raw == rhs.raw; }
  bool operator!=(const ErrorSubcategory& rhs) const { return raw != rhs.raw; }
};
...
union ErrorPayload {
  ...
  bool is_error() const { return raw != 0; }
  bool operator==(const ErrorPayload& rhs) const { return raw == rhs.raw; }
  bool operator!=(const ErrorPayload& rhs) const { return raw != rhs.raw; }
};
...
struct ErrorEvent {
  ...
  bool operator==(const ErrorEvent& rhs) const {
    return error_category == rhs.error_category &&
           error_subcategory.raw == rhs.error_subcategory.raw &&
           payload.raw == rhs.payload.raw;
  }
  bool operator!=(const ErrorEvent& rhs) const { return !(*this == rhs); }

  friend std::ostream& operator<<(std::ostream&     os,
                                  const ErrorEvent& errorEvent) {
    os << "Category: " << static_cast<uint16_t>(errorEvent.error_category)
       << "; Subcategory: "
       << static_cast<uint16_t>(
              errorEvent.error_subcategory.charging_power_unit)
    ...
    switch (error_category) {
      ...
      case ErrorCategory::ChargingPowerUnit: {
        ...
        switch (subcategory) {
          ...
          case ErrorSubcategoryChargingPowerUnit::SoftStartFault:
          case ErrorSubcategoryChargingPowerUnit::
              SoftStartModuleCommunicationFailure:
          case ErrorSubcategoryChargingPowerUnit::SoftStartModuleOverloaded:
          case ErrorSubcategoryChargingPowerUnit::SoftStartModuleFault:
          case ErrorSubcategoryChargingPowerUnit::
              SoftStartModuleOvertemperature:
          case ErrorSubcategoryChargingPowerUnit::
              SoftStartModuleUndertemperature:
          case ErrorSubcategoryChargingPowerUnit::
              SoftStartModuleDisconnectionFailure:
          case ErrorSubcategoryChargingPowerUnit::PhaseSequenceAbornmalAlarm:
          case ErrorSubcategoryChargingPowerUnit::
              PowerDistributionModuleCommunicationFailure:
          case ErrorSubcategoryChargingPowerUnit::
              FaultOfInsulationResistanceToGround:
            oss << "Subcategory: " << subcategory << "; ";
            oss << "AlarmState: " << payload.alarm;
...
class ErrorRegisters {
 ...
 private:
  struct {
    ...
    DataProviderHolding<AlarmStatus> door_status_sensor =
        DataProviderHolding<AlarmStatus>(AlarmStatus::NORMAL);
    DataProviderHolding<AlarmStatus> water =
        DataProviderHolding<AlarmStatus>(AlarmStatus::NORMAL);
    DataProviderHolding<AlarmStatus> smoke =
        DataProviderHolding<AlarmStatus>(AlarmStatus::NORMAL);
    DataProviderHolding<AlarmStatus> epo =
        DataProviderHolding<AlarmStatus>(AlarmStatus::NORMAL);
  } power_unit;

  struct {
    DataProviderHolding<AlarmStatus> unknown_system_type =
        DataProviderHolding<AlarmStatus>(AlarmStatus::NORMAL);
    ...
    DataProviderHolding<AlarmStatus>
        syncrhonization_cable_status_fault_of_energy_routing_board =
            DataProviderHolding<AlarmStatus>(AlarmStatus::NORMAL);
    DataProviderHolding<AlarmStatus> soft_start_fault =
        DataProviderHolding<AlarmStatus>(AlarmStatus::NORMAL);
    ...
    DataProviderHolding<AlarmStatus> fault_of_insulation_resistance_to_ground =
        DataProviderHolding<AlarmStatus>(AlarmStatus::NORMAL);
    DataProviderHolding<uint16_t> modbus_tcp_certificate =
        DataProviderHolding<uint16_t>(0);
  } charging_power_unit;

  struct {
    DataProviderHolding<uint32_t> ac_branch_1 =
        DataProviderHolding<uint32_t>(0);
    DataProviderHolding<uint32_t> ac_branch_2 =
        DataProviderHolding<uint32_t>(0);
  } ac_branch;

  struct {
    DataProviderHolding<uint32_t> rectifier_1 =
        DataProviderHolding<uint32_t>(0);
    DataProviderHolding<uint32_t> rectifier_2 =
        DataProviderHolding<uint32_t>(0);
    DataProviderHolding<uint32_t> rectifier_3 =
        DataProviderHolding<uint32_t>(0);
    DataProviderHolding<uint32_t> rectifier_4 =
        DataProviderHolding<uint32_t>(0);
    DataProviderHolding<uint32_t> rectifier_5 =
        DataProviderHolding<uint32_t>(0);
    DataProviderHolding<uint32_t> rectifier_6 =
        DataProviderHolding<uint32_t>(0);
  } ac_dc_rectifier;

  struct {
    DataProviderHolding<uint32_t> dc_dc_module_1 =
        DataProviderHolding<uint32_t>(0);
    DataProviderHolding<uint32_t> dc_dc_module_2 =
        DataProviderHolding<uint32_t>(0);
    DataProviderHolding<uint32_t> dc_dc_module_3 =
        DataProviderHolding<uint32_t>(0);
    DataProviderHolding<uint32_t> dc_dc_module_4 =
        DataProviderHolding<uint32_t>(0);
    DataProviderHolding<uint32_t> dc_dc_module_5 =
        DataProviderHolding<uint32_t>(0);
    DataProviderHolding<uint32_t> dc_dc_module_6 =
        DataProviderHolding<uint32_t>(0);
    DataProviderHolding<uint32_t> dc_dc_module_7 =
        DataProviderHolding<uint32_t>(0);
    DataProviderHolding<uint32_t> dc_dc_module_8 =
        DataProviderHolding<uint32_t>(0);
    DataProviderHolding<uint32_t> dc_dc_module_9 =
        DataProviderHolding<uint32_t>(0);
    DataProviderHolding<uint32_t> dc_dc_module_10 =
        DataProviderHolding<uint32_t>(0);
    DataProviderHolding<uint32_t> dc_dc_module_11 =
        DataProviderHolding<uint32_t>(0);
    DataProviderHolding<uint32_t> dc_dc_module_12 =
        DataProviderHolding<uint32_t>(0);
  } dc_dc_charging_module;

  struct {
    DataProviderHolding<uint32_t> cooling_unit_1 =
        DataProviderHolding<uint32_t>(0);
  } cooling_section;

  struct {
    DataProviderHolding<uint32_t> power_distribution_module_1 =
        DataProviderHolding<uint32_t>(0);
    DataProviderHolding<uint32_t> power_distribution_module_2 =
        DataProviderHolding<uint32_t>(0);
    DataProviderHolding<uint32_t> power_distribution_module_3 =
        DataProviderHolding<uint32_t>(0);
    DataProviderHolding<uint32_t> power_distribution_module_4 =
        DataProviderHolding<uint32_t>(0);
    DataProviderHolding<uint32_t> power_distribution_module_5 =
        DataProviderHolding<uint32_t>(0);
...
#define POWER_UNIT_ALARM_CALLBACK(SUBCATEGORY)   \
  ERROR_ALARM_CALLBACK(ErrorCategory::PowerUnit, \
                       ErrorSubcategory{.power_unit = SUBCATEGORY})

#define CHARGING_POWER_UNIT_ALARM_CALLBACK(SUBCATEGORY)  \
  ERROR_ALARM_CALLBACK(ErrorCategory::ChargingPowerUnit, \
                       ErrorSubcategory{.charging_power_unit = SUBCATEGORY})

#define AC_BRANCH_BITFLAGS_CALLBACK(SUBCATEGORY)   \
  ERROR_BITFLAGS_CALLBACK(ErrorCategory::AcBranch, \
                          ErrorSubcategory{.ac_branch = SUBCATEGORY})

#define AC_DC_RECTIFIER_BITFLAGS_CALLBACK(SUBCATEGORY)  \
  ERROR_BITFLAGS_CALLBACK(ErrorCategory::AcDcRectifier, \
                          ErrorSubcategory{.ac_dc_rectifier = SUBCATEGORY})

#define DC_DC_CHARGING_BITFLAGS_CALLBACK(SUBCATEGORY) \
  ERROR_BITFLAGS_CALLBACK(                            \
      ErrorCategory::DcDcChargingModule,              \
      ErrorSubcategory{.dc_dc_charging_module = SUBCATEGORY})

#define COOLING_SECTION_BITFLAGS_CALLBACK(SUBCATEGORY)   \
  ERROR_BITFLAGS_CALLBACK(ErrorCategory::CoolingSection, \
                          ErrorSubcategory{.cooling_section = SUBCATEGORY})
...
#define POWER_DISTRIBUTION_BITFLAGS_CALLBACK(SUBCATEGORY)     \
  ...
  void add_callback_to_alarm_power_unit_registers(
      std::function<void(ErrorEvent)> callback) {
    power_unit.high_voltage_door_status_sensor.add_write_callback(
        POWER_UNIT_ALARM_CALLBACK(
    ...
    power_unit.water.add_write_callback(
        POWER_UNIT_ALARM_CALLBACK(ErrorSubcategoryPowerUnit::Water));

    power_unit.smoke.add_write_callback(
        POWER_UNIT_ALARM_CALLBACK(ErrorSubcategoryPowerUnit::Smoke));

    power_unit.epo.add_write_callback(
        POWER_UNIT_ALARM_CALLBACK(ErrorSubcategoryPowerUnit::Epo));
  }

  void add_callback_to_alarm_charging_power_unit_registers(
      std::function<void(ErrorEvent)> callback) {
    charging_power_unit.unknown_system_type.add_write_callback(
        CHARGING_POWER_UNIT_ALARM_CALLBACK(
            ErrorSubcategoryChargingPowerUnit::UnknownSystemType));

    charging_power_unit.power_detection_exception.add_write_callback(
        CHARGING_POWER_UNIT_ALARM_CALLBACK(
            ErrorSubcategoryChargingPowerUnit::PowerDetectionException));
    ...
    charging_power_unit.soft_start_module_fault.add_write_callback(
        CHARGING_POWER_UNIT_ALARM_CALLBACK(
            ErrorSubcategoryChargingPowerUnit::SoftStartModuleFault));

    charging_power_unit.soft_start_module_overtemperature.add_write_callback(
        CHARGING_POWER_UNIT_ALARM_CALLBACK(
            ErrorSubcategoryChargingPowerUnit::SoftStartModuleOvertemperature));
  ...
  void add_callback_to_ac_branch_registers(
      std::function<void(ErrorEvent)> callback) {
    ac_branch.ac_branch_1.add_write_callback(
        AC_BRANCH_BITFLAGS_CALLBACK(ErrorSubcategoryAcBranch::AcBranch1));

    ac_branch.ac_branch_2.add_write_callback(
        AC_BRANCH_BITFLAGS_CALLBACK(ErrorSubcategoryAcBranch::AcBranch2));
  }

  void add_callback_to_ac_dc_rectifier_registers(
      std::function<void(ErrorEvent)> callback) {
    ac_dc_rectifier.rectifier_1.add_write_callback(
        AC_DC_RECTIFIER_BITFLAGS_CALLBACK(
            ErrorSubcategoryAcDcRectifier::rectifier_1));

    ac_dc_rectifier.rectifier_2.add_write_callback(
        AC_DC_RECTIFIER_BITFLAGS_CALLBACK(
            ErrorSubcategoryAcDcRectifier::rectifier_2));

    ac_dc_rectifier.rectifier_3.add_write_callback(
        AC_DC_RECTIFIER_BITFLAGS_CALLBACK(
            ErrorSubcategoryAcDcRectifier::rectifier_3));

    ac_dc_rectifier.rectifier_4.add_write_callback(
        AC_DC_RECTIFIER_BITFLAGS_CALLBACK(
            ErrorSubcategoryAcDcRectifier::rectifier_4));

    ac_dc_rectifier.rectifier_5.add_write_callback(
        AC_DC_RECTIFIER_BITFLAGS_CALLBACK(
            ErrorSubcategoryAcDcRectifier::rectifier_5));
  ...
  void add_callback_to_cooling_section_registers(
      std::function<void(ErrorEvent)> callback) {
    cooling_section.cooling_unit_1.add_write_callback(
        COOLING_SECTION_BITFLAGS_CALLBACK(
            ErrorSubcategoryCoolingSection::CoolingUnit1));
  }

  void add_callback_to_power_distribution_module_registers(
      std::function<void(ErrorEvent)> callback) {
    power_distribution_module.power_distribution_module_1.add_write_callback(
        POWER_DISTRIBUTION_BITFLAGS_CALLBACK(
    ...
    power_distribution_module.power_distribution_module_2.add_write_callback(
        POWER_DISTRIBUTION_BITFLAGS_CALLBACK(
            ErrorSubcategoryPowerDistributionModule::PowerDistributionModule2));

    power_distribution_module.power_distribution_module_3.add_write_callback(
        POWER_DISTRIBUTION_BITFLAGS_CALLBACK(
            ErrorSubcategoryPowerDistributionModule::PowerDistributionModule3));

    power_distribution_module.power_distribution_module_4.add_write_callback(
        POWER_DISTRIBUTION_BITFLAGS_CALLBACK(
            ErrorSubcategoryPowerDistributionModule::PowerDistributionModule4));
