...
struct ConnectorRegisters {
    ...
    // alarms
    DataProviderHoldingUnsolicitatedReportCallback<uint16_t> dc_output_contact_fault;
    DataProviderHoldingUnsolicitatedReportCallback<uint16_t> inverse_connection_dispenser_inlet_cable;
