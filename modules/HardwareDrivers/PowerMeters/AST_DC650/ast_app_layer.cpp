...
void AstAppLayer::create_command_start_transaction(ast_app_layer::UserIdStatus user_id_status,
                                                   ast_app_layer::UserIdType user_id_type, std::string user_id_data,
    ...
    cmd.data.push_back(
        static_cast<uint8_t>(gmt_offset_quarter_hours)); // GMT offset in quarters of an hour, e.g. 0x08 = +2h
...
void AstAppLayer::create_command_set_time(date::utc_clock::time_point timepoint, int8_t gmt_offset_quarters_of_an_hour,
                                          std::vector<uint8_t>& command_data) {
    ast_app_layer::Command cmd{};
...
*/
void AstAppLayer::create_command_get_transaction_ocmf(uint32_t ocmf_id, std::vector<uint8_t>& command_data) {
    ast_app_layer::Command cmd{};
...
void AstAppLayer::create_command_get_log_entry(uint32_t log_entry_id, std::vector<uint8_t>& command_data) {
    ast_app_layer::Command cmd{};
...
*/
void AstAppLayer::create_command_get_log_entry_reverse(uint32_t log_entry_id, std::vector<uint8_t>& command_data) {
    ast_app_layer::Command cmd{};
