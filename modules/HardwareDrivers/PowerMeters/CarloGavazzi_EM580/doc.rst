...
The module ``CarloGavazzi_EM580`` implements powermeter interface to read data from 
EM580 device that is connected via Modbus RTU. 


Testing the module
==================
We use the MQTT Explorer to interact with the CarloGavazzi_EM580 module.
