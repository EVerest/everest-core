...
public:
    ...
    void create_command_start_transaction(app_layer::UserIdStatus user_id_status, app_layer::UserIdType user_id_type,
                                          std::string user_id_data, std::vector<uint8_t>& command_data);
    ...
    void create_command_set_bus_address(uint8_t bus_address, std::vector<uint8_t>& command_data);
    ...
    void create_command_get_transaction_ocmf(uint32_t ocmf_id, std::vector<uint8_t>& command_data);
    ...
    void create_command_get_log_entry(uint32_t log_entry_id, std::vector<uint8_t>& command_data);
    void create_command_get_last_log_entry(std::vector<uint8_t>& command_data);
    void create_command_get_log_entry_reverse(uint32_t log_entry_id, std::vector<uint8_t>& command_data);

    void create_command_get_application_mode(std::vector<uint8_t>& command_data);
    void create_command_set_application_mode(app_layer::ApplicationBoardMode mode, std::vector<uint8_t>& command_data);

    void create_command_get_line_loss_impedance(std::vector<uint8_t>& command_data);
    void create_command_set_line_loss_impedance(uint16_t ll_impedance, std::vector<uint8_t>& command_data);
...
private:
    std::vector<uint8_t> create_command(app_layer::Command cmd);
    std::vector<uint8_t> create_simple_command(app_layer::CommandType cmd_type);
};
