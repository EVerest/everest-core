...
void to_json(json& j, const DeviceDiagnostics& k) {
    ...
    j["type"] = k.type;
    j["HW_ver"] = k.hw_ver;
    j["server_id"] = k.server_id;
    j["serial_nr"] = k.serial_number;
    j["application"] = json();
    j["application"]["mode"] = k.application.mode;
    j["application"]["FW_ver"] = k.application.fw_ver;
    j["application"]["FW_CRC"] = module::conversions::hexdump(k.application.fw_crc);
    j["application"]["FW_hash"] = module::conversions::hexdump(k.application.fw_hash);
    j["metering"] = json();
    j["metering"]["FW_ver"] = k.metering.fw_ver;
    j["metering"]["FW_CRC"] = module::conversions::hexdump(k.metering.fw_crc);
    j["bus_address"] = k.bus_address;
...
void from_json(const json& j, DeviceDiagnostics& k) {
    ...
    // k.hw_ver = j.at("");
    // k.server_id = j.at("");
    // k.serial_number = j.at("");
    // k.application.mode = j.at("");
    // k.application.fw_ver = j.at("");
    // k.application.fw_crc = j.at("");
    // k.application.fw_hash = j.at("");
    // k.metering.fw_ver = j.at("");
    // k.metering.fw_crc = j.at("");
    // k.bus_address = j.at("");
    // k.bootl_ver = j.at("");
