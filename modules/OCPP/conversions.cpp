...
to_ocpp_hash_algorithm_enum_type(const types::iso15118::HashAlgorithm hash_algorithm) {
    ...
    throw std::out_of_range(
        "Could not convert types::iso15118::HashAlgorithm to ocpp::v16::HashAlgorithmEnumType");
}
...
types::iso15118::Status
to_everest_iso15118_status(const ocpp::v201::Iso15118EVCertificateStatusEnum status) {
    switch (status) {
    ...
    throw std::out_of_range(
        "Could not convert ocpp::v201::Iso15118EVCertificateStatusEnum to types::iso15118::Status");
}
