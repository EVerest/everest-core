...
#ifndef ENERGY_SOURCE_AND_SINK_ENERGY_IMPL_HPP
#define ENERGY_SOURCE_AND_SINK_ENERGY_IMPL_HPP
...
public:
    energyImpl() = delete;
    energyImpl(Everest::ModuleAdapter* ev, const Everest::PtrContainer<OCPP>& mod, Conf& config) :
        energyImplBase(ev, "energy_source_and_sink"), mod(mod), config(config){};
...
#endif // ENERGY_SOURCE_AND_SINK_ENERGY_IMPL_HPP
