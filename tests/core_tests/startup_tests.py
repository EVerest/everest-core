...
class ProbeModule:
    ...
    def test(self, timeout: float, mode: Mode) -> bool:
        ...
        if mode == Mode.HlcAc:
            cmd = {'value': 'sleep 1;iso_wait_slac_matched;iso_start_v2g_session AC,auto;iso_wait_pwr_ready;iso_draw_power_regulated 16,3;iso_wait_for_stop 20;iso_wait_v2g_session_stopped;unplug'}
        elif mode == Mode.HlcDc:
            cmd = {'value': 'sleep 1;iso_wait_slac_matched;iso_start_v2g_session DC,auto;iso_wait_pwr_ready;iso_wait_for_stop 20;iso_wait_v2g_session_stopped;unplug'}
        else:
