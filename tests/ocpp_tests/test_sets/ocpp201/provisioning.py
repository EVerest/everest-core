...
async def test_B08_FR_07(central_system_v201: CentralSystem, test_controller: TestController, test_utility: TestUtility):
    log.info(" ############################# Test case B08: Get custom report ###############################")
    ...
    r: call_result201.SetVariablesPayload = await charge_point_v201.set_config_variables_req("ChargingStatusIndicator", "Active", "true")
    ...
    r = await charge_point_v201.get_report_req(request_id=567, component_criteria=[ComponentCriterionType.active])
    ...
    assert await wait_for_and_validate(test_utility, charge_point_v201, "NotifyReport", call201.NotifyReportPayload(
        request_id=567,
...
@pytest.mark.asyncio
@pytest.mark.ocpp_version("ocpp2.0.1")
async def test_B08_FR_08(central_system_v201: CentralSystem, test_controller: TestController, test_utility: TestUtility):
    """
    B08.FR.08
...
@pytest.mark.asyncio
@pytest.mark.ocpp_version("ocpp2.0.1")
async def test_B08_FR_09(central_system_v201: CentralSystem, test_controller: TestController, test_utility: TestUtility):
    ...
    r: call_result201.SetVariablesPayload = await charge_point_v201.set_config_variables_req("SampledDataCtrlr", "Enabled", "false")
    set_variable_result: SetVariableResultType = SetVariableResultType(
        **r.set_variable_result[0])
    assert set_variable_result.attribute_status == SetVariableStatusType.accepted

    r = await charge_point_v201.get_report_req(request_id=1, component_criteria=[ComponentCriterionType.enabled],
                                               component_variable=[
...
@pytest.mark.asyncio
@pytest.mark.ocpp_version("ocpp2.0.1")
async def test_B08_FR_10(central_system_v201: CentralSystem, test_controller: TestController, test_utility: TestUtility):
    """
    B08.FR.10
    ...
    # set a component variable to true
    r: call_result201.SetVariablesPayload = await charge_point_v201.set_config_variables_req("ChargingStation", "Problem", "true")
    set_variable_result: SetVariableResultType = SetVariableResultType(
        **r.set_variable_result[0])
    assert set_variable_result.attribute_status == SetVariableStatusType.accepted

    r = await charge_point_v201.get_report_req(request_id=45, component_criteria=[ComponentCriterionType.problem])
...
@pytest.mark.ocpp_config_adaptions(GenericOCPP201ConfigAdjustment([
    (OCPP201ConfigVariableIdentifier("DeviceDataCtrlr", "BytesPerMessageGetReport", "Actual"), "42")]))
async def test_B08_FR_18(central_system_v201: CentralSystem, test_controller: TestController, test_utility: TestUtility):
    """
    B08.FR.18
    ...
    r: call_result201.GetVariablesPayload = await charge_point_v201.get_variables_req(get_variable_data=[
        GetVariableDataType(
            component=ComponentType(
                name="DeviceDataCtrlr"
            ),
    ...
    assert await wait_for_callerror_and_validate(test_utility, charge_point_v201, "FormatViolation")

@pytest.mark.asyncio
@pytest.mark.ocpp_version("ocpp2.0.1")
@pytest.mark.ocpp_config_adaptions(GenericOCPP201ConfigAdjustment([
    (OCPP201ConfigVariableIdentifier("DeviceDataCtrlr", "ItemsPerMessageGetReport"), "2")]))
async def test_B08_FR_17(central_system_v201: CentralSystem, test_controller: TestController, test_utility: TestUtility):
    ...
    r = await charge_point_v201.get_report_req(request_id=777, component_variable=[
        ComponentVariableType(
            component=ComponentType(
                name="TxCtrlr"
            ),
    ...
    assert await wait_for_callerror_and_validate(test_utility, charge_point_v201, "OccurenceConstraintViolation")

@pytest.mark.asyncio
@pytest.mark.ocpp_version("ocpp2.0.1")
async def test_TC_B_18_CS(central_system_v201: CentralSystem, test_controller: TestController, test_utility: TestUtility):
    ...
    r = await charge_point_v201.get_report_req(request_id=2534, component_criteria=[ComponentCriterionType.available], component_variable=[
        ComponentVariableType(
            component=ComponentType(
                name="EVSE",
                evse=EVSEType(id=1)
    ...
    r: call_result201.GetReportPayload = await charge_point_v201.get_report_req(request_id=2535, component_criteria=[ComponentCriterionType.problem], component_variable=[
        ComponentVariableType(
            component=ComponentType(
                name="EVSE",
                evse=EVSEType(id=1)
...
@pytest.mark.ocpp_version("ocpp2.0.1")
@pytest.mark.ocpp_config_adaptions(GenericOCPP201ConfigAdjustment([
    (OCPP201ConfigVariableIdentifier("DeviceDataCtrlr", "ItemsPerMessageGetReport"), "4"),
    (OCPP201ConfigVariableIdentifier("DeviceDataCtrlr", "ItemsPerMessageGetVariables"), "2")]))
async def test_TC_B_54_CS(central_system_v201: CentralSystem, test_controller: TestController, test_utility: TestUtility):
    """
    TC_B_54_CS
    ...
    r = await charge_point_v201.get_report_req(request_id=2538, component_variable=[
        ComponentVariableType(
            component=ComponentType(
                name="DeviceDataCtrlr",
            ),
...
@pytest.mark.ocpp_config_adaptions(GenericOCPP201ConfigAdjustment([
    (OCPP201ConfigVariableIdentifier("DeviceDataCtrlr", "ItemsPerMessageGetReport"), "4")]))
async def test_TC_B_55_CS(central_system_v201: CentralSystem, test_controller: TestController, test_utility: TestUtility):
    ...
    r = await charge_point_v201.get_report_req(request_id=2539, component_variable=[
        ComponentVariableType(
            component=ComponentType(
                name="DeviceDataCtrlr",
            ),
...
@pytest.mark.asyncio
@pytest.mark.ocpp_version("ocpp2.0.1")
async def test_TC_B_56_CS(central_system_v201: CentralSystem, test_controller: TestController, test_utility: TestUtility):
    ...
    r = await charge_point_v201.get_report_req(request_id=2544, component_variable=[
        ComponentVariableType(
            component=ComponentType(
                name="EVSE"
            ),
...
@ pytest.mark.asyncio
@pytest.mark.ocpp_version("ocpp2.0.1")
async def test_cold_boot_01(central_system_v201: CentralSystem, test_controller: TestController, test_utility: TestUtility):
    """
    B01.FR.01
    ...
    """
    ...
    try:
        ...
        assert await wait_for_and_validate(test_utility, charge_point_v201, "StatusNotification",
                                           call201.StatusNotificationPayload(datetime.now().isoformat(),
                                                                             ConnectorStatusType.available, 1, 1),
...
@ pytest.mark.asyncio
@pytest.mark.ocpp_version("ocpp2.0.1")
async def test_cold_boot_pending_01(test_config: OcppTestConfiguration, central_system_v201: CentralSystem, test_controller: TestController, test_utility: TestUtility):
    ...
    def on_boot_notification_pending(**kwargs):
        return call_result201.BootNotificationPayload(current_time=datetime.now().isoformat(),
                                                      interval=5, status=RegistrationStatusType.pending)
...
@ pytest.mark.asyncio
@pytest.mark.ocpp_version("ocpp2.0.1")
async def test_cold_boot_rejected_01(test_config: OcppTestConfiguration, central_system_v201: CentralSystem, test_controller: TestController, test_utility: TestUtility):
...
@ pytest.mark.asyncio
@pytest.mark.ocpp_version("ocpp2.0.1")
async def test_set_get_variables_01(charge_point_v201: ChargePoint201, test_utility: TestUtility):

    await charge_point_v201.get_variables_req(get_variable_data=[
        GetVariableDataType(
            component=ComponentType(
                name="TxCtrlr"
            ),
    ...
    assert await wait_for_and_validate(test_utility, charge_point_v201, "GetVariables", call_result201.GetVariablesPayload(
        get_variable_result=[
    ...
    await charge_point_v201.set_variables_req(set_variable_data=[
        SetVariableDataType(
...
@ pytest.mark.asyncio
@pytest.mark.ocpp_version("ocpp2.0.1")
async def test_set_get_variables_02(charge_point_v201: ChargePoint201, test_utility: TestUtility):
    await charge_point_v201.get_variables_req(get_variable_data=[
        GetVariableDataType(
            component=ComponentType(
                name="TxCtrlr"
...
@ pytest.mark.asyncio
@pytest.mark.ocpp_version("ocpp2.0.1")
async def test_get_base_report_01(charge_point_v201: ChargePoint201, test_utility: TestUtility):
    await charge_point_v201.get_base_report_req(request_id=1, report_base=ReportBaseType.full_inventory)

    await wait_for_and_validate(test_utility, charge_point_v201, "GetBaseReport", call_result201.GetBaseReportPayload(
    ...
    await charge_point_v201.get_report_req(
        ...
        component_variable=[
            ComponentVariableType(
                ...
                variable=VariableType(
                    name="NotAValidVariable"
                )
            ),
        ],
        component_criteria=[
            ComponentCriterionType.enabled
        ]
    )
...
@ pytest.mark.asyncio
@pytest.mark.ocpp_version("ocpp2.0.1")
async def test_b09_b10(charge_point_v201: ChargePoint201, test_controller: TestController, central_system_v201: CentralSystem):
    ...
    r: call_result201.GetVariablesPayload = await charge_point_v201.get_config_variables_req("InternalCtrlr", "NetworkConnectionProfiles")
    get_variables_result: GetVariableResultType = GetVariableResultType(
        **r.get_variable_result[0])
    assert get_variables_result.attribute_status == GetVariableStatusType.accepted
    ...
    r: call_result201.SetNetworkProfilePayload = await charge_point_v201.set_network_profile_req(configuration_slot=1, connection_data=NetworkConnectionProfileType(
    ...
    r: call_result201.SetNetworkProfilePayload = await charge_point_v201.set_network_profile_req(configuration_slot=100, connection_data=NetworkConnectionProfileType(
        ocpp_version=OCPPVersionType.ocpp20,
        ocpp_transport=OCPPTransportType.json,
        ocpp_csms_url="ws://localhost:9000/cp001",
        message_timeout=30,
    ...
    # valid
    r: call_result201.SetNetworkProfilePayload = await charge_point_v201.set_network_profile_req(configuration_slot=2, connection_data=NetworkConnectionProfileType(
        ocpp_version=OCPPVersionType.ocpp20,
        ocpp_transport=OCPPTransportType.json,
    ...
    r: call_result201.SetVariablesPayload = await charge_point_v201.set_config_variables_req("OCPPCommCtrlr", "NetworkConfigurationPriority", "2,1")
    set_variable_result: SetVariableResultType = SetVariableResultType(
        **r.set_variable_result[0])
    assert set_variable_result.attribute_status == SetVariableStatusType.accepted
...
@pytest.mark.ocpp_config_adaptions(GenericOCPP201ConfigAdjustment([
    (OCPP201ConfigVariableIdentifier("DeviceDataCtrlr", "ItemsPerMessageGetVariables"), "2")]))
async def test_B06_09_16(central_system_v201: CentralSystem, test_controller: TestController, test_utility: TestUtility):
    """
    B06.FR.09
    B06.FR.16
    """
    log.info(" ############################# Test case B06: Get variables Request ###############################")
    ...
    r: call_result.SetVariablesPayload = await charge_point_v201.set_config_variables_req("SecurityCtrlr", "BasicAuthPassword", "8BADF00D8BADF00D")
    set_variable_result: SetVariableResultType = SetVariableResultType(
        **r.set_variable_result[0])
    assert set_variable_result.attribute_status == SetVariableStatusType.accepted
    ...
    r: call_result201.GetVariablesPayload = await charge_point_v201.get_config_variables_req("SecurityCtrlr", "BasicAuthPassword")
    get_variables_result: GetVariableResultType = GetVariableResultType(
        **r.get_variable_result[0])
...
@ pytest.mark.asyncio
@pytest.mark.ocpp_version("ocpp2.0.1")
async def test_B04(central_system_v201: CentralSystem, test_controller: TestController, test_utility: TestUtility):
    """
    B04.FR.01
    B04.FR.02
    ...
    ...
    log.info(" ############################# Test case B04: Offline Idle Behaviour ###############################")
    ...
    r: call_result201.SetVariablesPayload = await charge_point_v201.set_config_variables_req("OCPPCommCtrlr", "OfflineThreshold", "15")
    set_variable_result: SetVariableResultType = SetVariableResultType(
        **r.set_variable_result[0])
    assert set_variable_result.attribute_status == SetVariableStatusType.accepted
    ...
    for index in range(3):
        ...
        assert await wait_for_and_validate(test_utility, charge_point_v201, "Heartbeat", call.HeartbeatPayload())
    ...
    assert await wait_for_and_validate(test_utility, charge_point_v201, "StatusNotification", call201.StatusNotificationPayload(datetime.now().isoformat(),
                                                                                                                                ConnectorStatusType.occupied, evse_id=evse_id2, connector_id=connector_id), validate_status_notification_201)
