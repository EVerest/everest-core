...
async def test_cleanup_transaction_events_after_max_attempts_exhausted(
    ...
    assert (
        central_system.mock.on_transaction_event.call_count == 4
    )  # initial transaction start and 3 attempts for transaction update
    ...
    assert (
        central_system.mock.on_transaction_event.call_count == 5
    )  # initial transaction start and 3 attempts for transaction update and transaction end
