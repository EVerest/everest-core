...
def everest_core_repos():
    ...
    maybe(
        ...
        url = "https://github.com/everest/everest-framework/archive/d1f723c728e0f7eb286d6f2a86ebe188c146bdc2.tar.gz",
        strip_prefix = "everest-framework-d1f723c728e0f7eb286d6f2a86ebe188c146bdc2",
    )
