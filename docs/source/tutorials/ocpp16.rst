...
If you're new to EVerest start with our :ref:`TODO Quick Start Guide <quickstartguide_main>`
...
about these containers, see the :ref:`TODO EVerest Docker Setup page <docker_setup>`.
...
`TODO link to module ref in the manifest of the module <https://github.com/EVerest/everest-core/blob/main/modules/OCPP/manifest.yaml>`_
and read the
`TODO module documentation <https://everest.github.io/nightly/_generated/modules/OCPP.html>`_
