...
* Request to become a committer. To do this, please either contact the TSC
  or an existing committer in one of the working group meetings or channels.
...
See `TSC Readme <https://github.com/EVerest/EVerest/blob/main/tsc/README.md>`_ for details.

Release Process
================

Project releases will occur on a scheduled basis as agreed to by the
committers. See :doc:`TODO Release documentation </project/releases/release-and-versioning>` for details.
